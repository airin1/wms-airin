...
//        $data['yor'] = \App\Models\SorYor::where('type', 'yor')->first();
        ...
        //$rfr20arn1 = \App\Models\Containercy::whereNull('TGLRELEASE')->whereNotNull('TGLMASUK')->where('GUDANG_TUJUAN','=','ARN1')->where('SIZE', '=','20')->where('jenis_container', '=','REEFER RECOOLING')->count();
        //$rfr40arn1 = \App\Models\Containercy::whereNull('TGLRELEASE')->whereNotNull('TGLMASUK')->where('GUDANG_TUJUAN','=','ARN1')->where('SIZE','>=','40')->where('jenis_container', '=','REEFER RECOOLING')->count();
		...
		//$dryyorarn1 =$dryarn1/$drykaparn1;
		//$rfryorarn1 =$rfrarn1/$rfrkaparn1;
		//$dgyorarn1 =$dgarn1/$dgkaparn1;
		//$data['yorarn1'] = array(
        ...
        //$rfr20arn3 = \App\Models\Containercy::whereNull('TGLRELEASE')->whereNotNull('TGLMASUK')->where('GUDANG_TUJUAN','=','ARN3')->where('SIZE', '=','20')->where('jenis_container', '=','REEFER RECOOLING')->count();
        //$rfr40arn3 = \App\Models\Containercy::whereNull('TGLRELEASE')->whereNotNull('TGLMASUK')->where('GUDANG_TUJUAN','=','ARN3')->where('SIZE','>=','40')->where('jenis_container', '=','REEFER RECOOLING')->count();
		...
		//$dryyorarn3 =$dryarn3/$drykaparn3;
		//$rfryorarn3 =$rfrarn3/$rfrkaparn3;
		//$dgyorarn3 =$dgarn3/$dgkaparn3;
		//$data['yorarn3'] = array(
