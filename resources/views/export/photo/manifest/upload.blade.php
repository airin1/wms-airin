                ...
                <div class="col-md-12">
                    <div class="box-body">       
                         <table id="example1" class="table table-bordered table-striped">
                          <thead>
                            <tr>
                                <th>Action <button type="button" class="btn upload" data-id="{{$manifest}}"> <i class="fa fa-plus"></i> </button></th>
                                <th>Kegiatan</th>
                                <th>Photo</th>
                                <th>Upload</th>
                                <th>UID</th>
                            ...
                            <tr>
                                ...
                                <td>{{$photo->activity}}</td>
                                 ...
                                 <td>
                                    ...
                                    <img src="{{ asset('/uploads/photos/export/manifest/' . $photo->photo) }}" alt=""  width="70" height="70"><br>
