...
<div class="box box-default">
    ...
    <!-- /.box-header -->
    <form class="form-horizontal" action="{{ route('exp-register-store') }}" method="POST">
        <div class="box-body">            
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="NOBOOKING" class="form-control"  value="{{ old('NOBOOKING') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group date">
                                ...
                                <input type="text" name="TGL_BOOKING" class="form-control pull-right datepicker" value="{{ old('TGL_BOOKING') }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-6"> 
                    <div class="form-group">                       
                        ...
                        <div class="col-sm-3">
                            <input type="text" name="KODE_GUDANG" value="ARN1" class="form-control" required>
                        </div>
                        <label class="col-sm-2 control-label">Tujuan</label>
                        <div class="col-sm-3">
                            <input type="text" name="GUDANG_TUJUAN" value="ARN1" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group">
