    ...
    <div id="lap-masuk" @if($type == 'out') style="display: none;" @endif>
        <div class="row invoice-info">
            <div style="text-align: center;">
                ...
                <h4 style="margin-bottom: 0;margin-top: 0;">LAPANGAN TPS PT. AIRIN{{$nmgd}}</h4>
    ...
    <div id="lap-keluar" @if($type == 'in') style="display: none;" @endif>
        ...
        <div class="row" style="float: left;">
         ...
         <div class="row" style="float: right;">
            ...
            <p>STOCK CONTAINER LAPANGAN TPS PT.AIRIN {{$nmgd}}</p>
                <table border="1" cellspacing="0" cellpadding="0">
                    <tbody>
                        <tr>
                            <th>Keterangan</th>
                        ...
                        <tr>
                            <th>Stock Awal</th>
                            <td align="center" style="text-align: center;border-top: none;border-bottom: none;">{{ $stok['awal'][0]->total }}</td>
                            <td align="center" style="text-align: center;border-top: none;border-bottom: none;">{{ $stok['awal'][1]->total }}</td>
                            <td align="center" style="text-align: center;border-top: none;border-bottom: none;">{{ $stok['awal'][2]->total }}</td>
                            <td align="center" style="text-align: center;border-top: none;border-bottom: none;">{{ $stok['awal'][0]->total+$stok['awal'][1]->total+$stok['awal'][2]->total}}</td>
                            <td align="center" style="text-align: center;border-top: none;border-bottom: none;">{{ ($stok['awal'][0]->total)+($stok['awal'][1]->total*2)+($stok['awal'][2]->total*2) }}</td>
                            <th rowspan="4" align="center" style="text-align: center;vertical-align: middle;">{{ number_format($tot_sor,'2',',','.') }}</th>
                        </tr>
                        <tr>
                            <th>Cont Masuk</th>
                            <td align="center" style="text-align: center;border-top: none;border-bottom: none;">{{ $stok['masuk'][0]->total }}</td>
                            <td align="center" style="text-align: center;border-top: none;border-bottom: none;">{{ $stok['masuk'][1]->total }}</td>
                            <td align="center" style="text-align: center;border-top: none;border-bottom: none;">{{ $stok['masuk'][2]->total }}</td>
                            <td align="center" style="text-align: center;border-top: none;border-bottom: none;">{{ $stok['masuk'][0]->total+$stok['masuk'][1]->total+$stok['masuk'][2]->total}}</td>
                            <td align="center" style="text-align: center;border-top: none;border-bottom: none;">{{ ($stok['masuk'][0]->total)+($stok['masuk'][1]->total*2)+($stok['masuk'][2]->total*2) }}</td>
                        </tr>
                        <tr>
                            <th>Cont Keluar</th>
                            <td align="center" style="text-align: center;border-top: none;border-bottom: none;">{{ $stok['keluar'][0]->total }}</td>
                            <td align="center" style="text-align: center;border-top: none;border-bottom: none;">{{ $stok['keluar'][1]->total }}</td>
                            <td align="center" style="text-align: center;border-top: none;border-bottom: none;">{{ $stok['keluar'][2]->total }}</td>
                            <td align="center" style="text-align: center;border-top: none;border-bottom: none;">{{ $stok['keluar'][0]->total+$stok['keluar'][1]->total+$stok['keluar'][2]->total}}</td>
                            <td align="center" style="text-align: center;border-top: none;border-bottom: none;">{{ ($stok['keluar'][0]->total)+($stok['keluar'][1]->total*2)+($stok['keluar'][2]->total*2) }}</td>
                        </tr>
                        <tr>
                            <th>Stock Akhir</th>
