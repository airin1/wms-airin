            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="NOJOBORDER" class="form-control" value="{{ $joborder->NOJOBORDER }}" >
                        </div>
                    </div>
                    <div class="form-group">
...
<!--                                @foreach($pelabuhans as $pelabuhan)
                ...
                <div class="col-md-6"> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="JENISKEGIATAN" value="{{ $joborder->JENISKEGIATAN }}" class="form-control">
                        </div>
                    </div>
                    <div class="form-group" style="display: none;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <textarea name="prihal_surat" class="form-control" >Permohonan PLP-FCL Ke Gudang PT. AIRIN</textarea>
                                </div>
                            </div>
                            <div class="form-group">
