...
<!--    <div class="box-header with-border">
    ...
    <div class="box-body table-responsive">
        ...
        {{
            ...
            ->setGridOption('url', URL::to('/container/grid-data-cy?module=release-log&_token='.csrf_token()))
...
//            ->setGridEvent('onSelectRow', 'onSelectRowEvent')
            ...
            ->addColumn(array('label'=>'Tgl. SPPB','index'=>'TGL_SPPB', 'width'=>120,'align'=>'center'))
   		    ->addColumn(array('label'=>'Tgl. Release','index'=>'release_bc_date', 'width'=>120,'align'=>'center'))
   		    ->addColumn(array('label'=>'Release By','index'=>'release_bc_uid', 'width'=>120,'align'=>'center'))
