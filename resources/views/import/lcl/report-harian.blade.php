...
<div class="box">
    <div class="box-body table-responsive">
        ...
        {{
            ...
            ->setGridOption('url', URL::to('/lcl/manifest/grid-data?report=1&date='.$date.'&gd='.$gd.'&type=in&_token='.csrf_token()))
        ...
        {{
            ...
            ->setGridOption('mtype', 'POST')
            ->setGridOption('url', URL::to('/lcl/manifest/grid-data?report=1&date='.$date.'&gd='.$gd.'&type=out&_token='.csrf_token()))
            ->setGridOption('rowNum', 50)
            ->setGridOption('shrinkToFit', true)
            ->setGridOption('sortname','TMANIFEST_PK')
            ->setGridOption('sortorder','DESC')
...
<script type="text/javascript">
    ...
    $('#btn-print-in').click(function() {
        ...
        window.open("{{ route('lcl-report-harian-cetak', array('','','')) }}/"+date+"/in/"+gd,"preview wo fiat muat","width=1200,height=600,menubar=no,status=no,scrollbars=yes");
    });
    ...
    $('#btn-print-out').click(function() {
        ...
        window.open("{{ route('lcl-report-harian-cetak', array('','','')) }}/"+date+"/out/"+gd,"preview wo fiat muat","width=1200,height=600,menubar=no,status=no,scrollbars=yes");
    });
</script>
