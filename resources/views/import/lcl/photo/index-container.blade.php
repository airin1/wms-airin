...
<script>
    ...
    function onSelectRowEvent()
    {
        ...
        var rowid = $('#lclPhotoContainerGrid').jqGrid('getGridParam', 'selrow');
        var rowdata = $('#lclPhotoContainerGrid').getRowData(rowid);
...
<div class="box">
    <div class="box-header with-border">
        <h3 class="box-title">LCL Photo Container</h3>
    </div>
    <div class="box-body">
        <div class="row">
            <div class="col-md-12"> 
                {{
                    GridRender::setGridId("lclPhotoContainerGrid")
                    ->enableFilterToolbar()
...
//                    ->setGridEvent('gridComplete', 'gridCompleteEvent')
        ...
        //            ->addColumn(array('label'=>'Action','index'=>'action', 'width'=>80, 'search'=>false, 'sortable'=>false, 'align'=>'center'))
                    ...
                    ->addColumn(array('label'=>'No. SPK','index'=>'NOSPK','width'=>200))
                    ...
                    ->addColumn(array('label'=>'TPS Asal','index'=>'KD_TPS_ASAL', 'width'=>80,'hidden'=>false,'align'=>'center'))
                    ->addColumn(array('label'=>'Gudang','index'=>'LOKASI_GUDANG', 'width'=>80,'align'=>'center'))
        //            ->addColumn(array('label'=>'Teus','index'=>'TEUS', 'width'=>80,'align'=>'center'))
                    ...
                    ->addColumn(array('label'=>'Tgl. Masuk','index'=>'TGLMASUK','width'=>120,'hidden'=>true))
                    ->addColumn(array('label'=>'Jam Masuk','index'=>'JAMMASUK','width'=>120,'hidden'=>true))
...
<div id="photo-modal" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="modal">
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="upload-photo-form" action="{{ route('lcl-container-upload-photo') }}" method="POST" enctype="multipart/form-data">
                <div class="modal-body"> 
                    <div class="row">
                        <div class="col-md-12">
                            <input name="_token" type="hidden" value="{{ csrf_token() }}">
                            <input type="hidden" id="id_cont" name="id_cont" required>  
                            <input type="hidden" id="type" name="type" value="lcl" required>  
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control select2" id="kegiatan" name="kegiatan" style="width: 100%;" tabindex="-1" aria-hidden="true" required>
                                        ...
                                        <option value="gatein">Gate In / Aju Stripping</option>
                                        <option value="stripping">Hasil Stripping</option>
                                        <option value="empty">Buang Empty</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
