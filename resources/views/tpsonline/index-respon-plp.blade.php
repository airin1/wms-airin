...
<div class="box">
    ...
    <div class="box-body table-responsive">
        ...
        {{
            ...
            ->setGridOption('url', URL::to('/tpsonline/penerimaan/respon-plp/grid-data?jenis=fcl&_token='.csrf_token()))
...
<script type="text/javascript">
    ...
    $('#searchByDateBtn').on("click", function(){
        ...
        console.log(by);
        jQuery("#tpsResponPlpGrid").jqGrid('setGridParam',{url:"{{URL::to('/tpsonline/penerimaan/respon-plp/grid-data')}}?jenis=fcl&startdate="+startdate+"&enddate="+enddate+"&by="+by}).trigger("reloadGrid");
        return false;
    });
